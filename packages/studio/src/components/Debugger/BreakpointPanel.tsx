    ...
    return (
      <div className="h-full flex flex-col">
        <div className="p-3 border-b border-slate-200 dark:border-slate-700">
          <h2 className="font-semibold text-sm text-slate-700 dark:text-slate-200">Breakpoints</h2>
        </div>
        <div className="flex-1 flex items-center justify-center p-4">
          <div className="text-center text-sm text-slate-400 dark:text-slate-500">
            ...
            <p className="text-xs mt-1">Click a block in the debugger to add one</p>
          </div>
        </div>
      </div>
    );
    ...
    >
      <div className="flex items-center gap-2 px-2 py-1.5">
        ...
        <button
          ...
          aria-label={`Remove breakpoint at line ${breakpoint.line}`}
        >
